...
describe('Promise', function () {
    ...
    describe('#race', function () {
        ...
        it('should call the resolve callback when one of promises resolved', function (done) {
            Promise.race([
                new Promise(function (res, rej) { setTimeout(function () { res('one resolve') }, 10) }),
                new Promise(function (res, rej) { setTimeout(function () { rej('two reject') }, 20) }),
                new Promise(function (res, rej) { setTimeout(function () { res('three resolve') }, 30) })
            ])
                .then(function (value) {
                    flag = value;
                })
        ...
        it('should call the reject callback when one of promises rejected', function (done) {
            ...
            Promise
                .race([
                    new Promise(function (res, rej) { setTimeout(function () { res('one resolve') }, 20) }),
                    new Promise(function (res, rej) { setTimeout(function () { rej('two reject') }, 10) }),
                    new Promise(function (res, rej) { setTimeout(function () { res('three resolve') }, 30) })
                ])
                .then(function (value) {
                    flag = value;
    ...
    describe('#all', function () {
        it('should call the resolve callback when all promises resolved', function (done) {
            Promise
                .all([
                    new Promise(function (res, rej) { setTimeout(function () { res('one resolve') }, 10) }),
                    new Promise(function (res, rej) { setTimeout(function () { res('two resolve') }, 20) }),
                    new Promise(function (res, rej) { setTimeout(function () { res('three resolve') }, 30) })
                ])
        ...
        it('should call the reject callback when one of promises rejected', function (done) {
            ...
            Promise
                .all([
                    new Promise(function (res, rej) { setTimeout(function () { rej('one reject') }, 10) }),
                    new Promise(function (res, rej) { setTimeout(function () { rej('two reject') }, 20) }),
                    new Promise(function (res, rej) { setTimeout(function () { res('three resolve') }, 30) })
                ])
                .catch(function(error) {
